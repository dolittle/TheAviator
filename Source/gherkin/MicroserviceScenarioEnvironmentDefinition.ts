...
import { MicroserviceDefinition } from '@dolittle/aviator.microservices';
import { ScenarioEnvironmentDefinition } from '@dolittle/testing.gherkin';

export class MicroserviceScenarioEnvironmentDefinition extends ScenarioEnvironmentDefinition {
    ...
    withTenants(tenants: Guid[]): MicroserviceScenarioEnvironmentDefinition {
        this._tenants = tenants;
        return this;
    }

    withMicroservice(name: string, tenants: Guid[] | undefined): MicroserviceScenarioEnvironmentDefinition {
