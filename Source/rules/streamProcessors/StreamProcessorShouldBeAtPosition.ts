...
import { MissingStreamProcessorState, StreamProcessorPositionIsWrong } from './index';
 ...
 */
export class StreamProcessorShouldBeAtPosition implements IRule<ScenarioWithThenSubject<MicroserviceScenarioSubjectContent>> {
